...
const PurchasedTicket = ({
  ...
  <div className="relative flex flex-col">
          ...
          {/* Purchased date badge - moved further to the top */}
          <Badge className="absolute top-0 left-6 bg-red-500 text-white border-0 px-3 py-1 text-xs font-medium">
            Purchased date: {purchaseDate}
          </Badge>
          {/* Status badge */}
          <Badge className={`absolute top-0 right-0 ${status === 'active' ? 'bg-green-500' : 'bg-gray-400'} text-white border-0 px-3 py-1 text-xs font-medium`}>
        ...
        <div className="mt-8 grid grid-cols-[1fr,auto,1fr,auto] items-center gap-4">
          ...
          <div className="flex flex-col items-end gap-2 pl-6 border-l-2 border-dashed border-navy">
            ...
            <Button
              className="w-full bg-[#A54033] hover:bg-navy-dark text-white font-semibold px-6 py-2 rounded-full shadow-md transition-all"
              onClick={onShowQR}
            >
              Show QR
            </Button>
