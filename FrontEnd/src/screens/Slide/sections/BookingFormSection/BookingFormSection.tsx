...
export const BookingFormSection = (): JSX.Element => {
  ...
  const [dateTime, setDateTime] = useState("17  OCT 2025  at 23:00");

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Booking:", { from, to, dateTime });
  };
  ...
  return (
    <div className="relative w-full px-4 md:px-8">
      ...
      <div className="relative flex justify-center pt-12 md:pt-16 lg:pt-[101px] pb-24 md:pb-32 lg:pb-[200px]">
        <form
        ...
        >
          <div className="w-full h-auto flex bg-[#df695126] rounded-[31px] p-6 md:p-0">
            <div className="inline-flex w-full md:mt-[29.4px] md:w-[210px] md:h-[384.07px] md:ml-[81px] relative flex-col items-center justify-center gap-6 md:gap-[30px]">
                ...
                <div className="flex flex-col w-full md:w-[210px] items-start relative flex-[0_0_auto]">
                  <div className="gap-2.5 self-stretch w-full flex-[0_0_auto] bg-[#ffffff80] rounded border border-solid border-[#79747e] flex flex-col items-start relative">
                    <Select value={from} onValueChange={setFrom}>
                      <SelectTrigger className="flex items-center pl-4 pr-0 py-1 relative self-stretch w-full flex-[0_0_auto] rounded border-0 bg-transparent focus:ring-0 focus:ring-offset-0 h-auto">
              ...
              <Button
                type="submit"
                className="relative w-full md:w-[210px] h-12 md:h-14 bg-[#df6951] rounded-[14.5px] [font-family:'Inter',Helvetica] font-bold text-[#ffffff] text-lg md:text-[22px] hover:bg-[#df6951]/90 h-auto"
              >
                CONFIRM
              </Button>
            </div>
