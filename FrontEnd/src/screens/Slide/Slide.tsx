...
export const Slide = (): JSX.Element => {
  return (
    <div className="bg-[#ffffff] overflow-hidden w-full relative">
      ...
      <img
        className="absolute top-[22px] left-8 md:left-16 lg:left-[146px] w-[80px] md:w-[120px] lg:w-[164px] h-auto object-cover"
        alt="Chatgpt image oct"
        src="/chatgpt-image-18-oct--2025--00-01-05-1.png"
      />
    </div>
  );
};
